...
with menu_col:
    ...
    with st.container(border=True):
        ...
        st.info("כאן תוכלו לבחור איזה נתונים לראות: באיזה מחקר להתמקד (ימות החול / סופי שבוע), איזה סקר להציג (מבין ארבעת הגלים שנערכו) ובאיזה אוכלוסייה להתמקד")
        sel_p = st.selectbox("בחירת מחקר", ["ימות החול", "סוף שבוע"])
        waves = ["גל 19 במאי", "גל 25 במאי", "ממוצע שני הגלים"] if sel_p == "ימות החול" else ["גל 17 במאי", "גל 31 במאי", "ממוצע שני הגלים"]
