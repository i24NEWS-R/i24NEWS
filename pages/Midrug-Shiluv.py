...
with menu_col:
    ...
    with st.container(border=True):
        ...
        st.info("כאן תוכלו לבחור איזה נתונים לראות: איזה מחקר לראות (אמצע שבוע או סוף שבוע), איזה גל להציג (מבין ארבעת הגלים) ובאיזה אוכלוסייה להתמקד")
        sel_p = st.selectbox("בחירת מחקר", ["אמצע שבוע", "סוף שבוע"] help="בחר האם להציג נתונים ממחקר אמצע השבוע או ממחקר סוף השבוע.")
...
with chart_col:
    ...
    with st.container(border=True):
        ...
        st.warning("בחלק הזה ניתן לראות את תוצאות הסקר מול תוצאות המדרוג. בטבלה ניתן לראות את הפערים בין המדרוג לסקר - שינוי אבסולוטי או שינוי מחושב שלוקח בחשבון את הפער המובנה של הסקר מול המדרוג")
